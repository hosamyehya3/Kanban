...
const FormControlInput1 = document.getElementById("FormControlInput1") as HTMLOutputElement;
const clickMainBtn = document.getElementById("clickMainBtn");
const waringValid = document.getElementById('waringValid');
const text = document.getElementById("text") as HTMLOutputElement;
const date = document.getElementById("date") as HTMLOutputElement;
const description = document.getElementById("FormControlTextarea1") as HTMLOutputElement;
...
localStorage.setItem("saveCard" , JSON.stringify(arr))
      //   let arr: card[] = JSON.parse(localStorage.getItem("NewObj") || "[]")
